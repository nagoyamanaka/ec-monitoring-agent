...
import { MonitoringResourceNotFoundError } from "../../../../../Contexts/Monitoring/AlertAnalysis/application/errors/MonitoringResourceNotFoundError.js";
...
export function errorHandler(
  ...
  if (error instanceof ApplicationError) {
    if (error instanceof MonitoringResourceNotFoundError) {
