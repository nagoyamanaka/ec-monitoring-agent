...
> | 旧番号 | 内容 | 移動先 |
> | --- | --- | --- |
> | タスク19 | Forecast ドメイン型（ForecastSignal/RiskForecast/ForecastSignalSource） | step6 F1 |
> | タスク20 | ForecastMemory projection（突合キーB・`InvestigationReport.subject` 追記） | step6 F2 |
> | タスク21 | Gateway 未来シグナル ＋ ForecastSignalSource 3実装 | step6 F3 |
> | タスク22 | ForecastPort ＋ GeminiForecastAdapter | step6 F4 |
> | タスク23 | ForecastRiskCommandHandler（引用検証） | step6 F5 |
